...
public class NyiKeyBoard extends Keyboard {
    ...
    public NyiKeyBoard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }

    public NyiKeyBoard(Context context, int layoutTemplateResId,
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, 
        ...
        } else if (key.codes[0] == CustomKeyboardView.KEYCODE_LANGUAGE_SWITCH) {
    ...
    void setImeOptions(Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            ...
            case EditorInfo.IME_ACTION_SEARCH:
                ...
                //mEnterKey.icon=res.getDrawable(R.drawable.ic_search_white_18dp,null);
                //mEnterKey.icon=Drawable.createFromXml(R.drawable.ic_search_white_18dp,null);
    ...
    void setShistIcon(final Drawable icon){
        if(mShiftKey!=null){
            mShiftKey.icon=icon;
        }
    }
